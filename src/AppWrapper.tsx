...
function AppRoutes() {
  ...
  return (
    <ToastProvider>
      ...
      <Routes>
      {/* Public Routes */}
      <Route path="/" element={<ErrorBoundary pageName="/"><LandingPage /></ErrorBoundary>} />
      <Route path="/login" element={<ErrorBoundary pageName="/login"><LoginPage /></ErrorBoundary>} />
      <Route path="/register" element={<ErrorBoundary pageName="/register"><RegisterPage /></ErrorBoundary>} />
      <Route path="/auth/callback" element={<ErrorBoundary pageName="/auth/callback"><AuthCallback /></ErrorBoundary>} />
      <Route path="/pricing" element={<ErrorBoundary pageName="/pricing"><PricingPage /></ErrorBoundary>} />
      <Route path="/forgot-password" element={<ErrorBoundary pageName="/forgot-password"><ForgotPasswordPage /></ErrorBoundary>} />
        <Route path="/verify-email" element={<ErrorBoundary pageName="/verify-email"><VerifyEmailPage /></ErrorBoundary>} />
      <Route path="/terms" element={<ErrorBoundary pageName="/terms"><TermsPage /></ErrorBoundary>} />
      <Route path="/privacy" element={<ErrorBoundary pageName="/privacy"><PrivacyPage /></ErrorBoundary>} />
        <Route path="/refund" element={<ErrorBoundary pageName="/refund"><RefundPolicyPage /></ErrorBoundary>} />
      <Route path="/about" element={<ErrorBoundary pageName="/about"><AboutPage /></ErrorBoundary>} />
        <Route path="/changelog" element={<ErrorBoundary pageName="/changelog"><ChangelogPage /></ErrorBoundary>} />
        <Route path="/status" element={<ErrorBoundary pageName="/status"><StatusPage /></ErrorBoundary>} />
        <Route path="/api-docs" element={<ErrorBoundary pageName="/api-docs"><ApiDocsPage /></ErrorBoundary>} />
      <Route path="/contact" element={<ErrorBoundary pageName="/contact"><ContactPage /></ErrorBoundary>} />
      <Route path="/features" element={<ErrorBoundary pageName="/features"><FeaturesPage /></ErrorBoundary>} />
