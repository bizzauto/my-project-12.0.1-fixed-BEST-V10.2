                  ...
                  {reminderConfig.enabled && (
                    <div className="grid grid-cols-2 gap-3 ml-8">
                      ...
                      <div>
                        ...
                        <select value={reminderConfig.method} onChange={e => setReminderConfig({ ...reminderConfig, method: e.target.value as 'whatsapp' | 'email' | 'both' })}
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
            ...
            {isRecurring && (
              <div className="flex gap-3 mt-2 ml-6">
                <select value={recurringFreq} onChange={e => setRecurringFreq(e.target.value as string)}
