      ...
      <div className="text-center max-w-lg">
        ...
        <div className="flex gap-4 justify-center">
          <button onClick={() => navigate('/')}
            className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 flex items-center gap-2 cursor-pointer">
            <Home size={18} /> Go Home
          </button>
          <button onClick={() => window.history.back()}
            className="px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 flex items-center gap-2 cursor-pointer">
        ...
        <div className="mt-12 grid grid-cols-3 gap-4 text-center">
          {[
            ...
            <button key={i} onClick={() => navigate(link.path)}
              className="p-3 bg-white rounded-lg shadow-sm border border-gray-100 text-sm text-gray-600 hover:text-blue-600 hover:border-blue-200 transition-colors cursor-pointer">
              {link.label}
            </button>
          ))}
        </div>
